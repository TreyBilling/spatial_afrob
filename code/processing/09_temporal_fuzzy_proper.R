...
gtd_buffers <- 
  map(.x = afrob_sf_buffers2, ~st_join(gtd_sf2, .x) %>% 
        st_drop_geometry() %>% 
        filter(!is.na(geoid)) %>% 
        setDT())
...
save(attacks_buff, file = here::here("processed", "attacks_buff_proper.Rdata"))
...
df_attacks_prop <-
  ...
  mutate(
    ...
    future_prop_attacks3_months_10km = case_when(prop_attacks3_months_10km == 0 & prop_attacks99_months_10km > 0 ~ 1,
                                                 TRUE ~ 0),
    future_prop_attacks6_months_10km = case_when(prop_attacks6_months_10km == 0 & prop_attacks99_months_10km > 0 ~ 1,
                                                 TRUE ~ 0),
    future_prop_attacks12_months_10km = case_when(prop_attacks12_months_10km == 0 & prop_attacks99_months_10km > 0 ~ 1,
                                                  TRUE ~ 0),
    
    
    future_prop_attacks3_months_25km = case_when(prop_attacks3_months_25km == 0 & prop_attacks99_months_25km > 0 ~ 1,
                                                 TRUE ~ 0),
    future_prop_attacks6_months_25km = case_when(prop_attacks6_months_25km == 0 & prop_attacks99_months_25km > 0 ~ 1,
                                                 TRUE ~ 0),
    future_prop_attacks12_months_25km = case_when(prop_attacks12_months_25km == 0 & prop_attacks99_months_25km > 0 ~ 1,
                                                  TRUE ~ 0),
    
    future_prop_attacks3_months_50km = case_when(prop_attacks3_months_50km == 0 & prop_attacks99_months_50km > 0 ~ 1,
                                                 TRUE ~ 0),
    future_prop_attacks6_months_50km = case_when(prop_attacks6_months_50km == 0 & prop_attacks99_months_50km > 0 ~ 1,
                                                 TRUE ~ 0),
    future_prop_attacks12_months_50km = case_when(prop_attacks12_months_50km == 0 & prop_attacks99_months_50km > 0 ~ 1,
                                                  TRUE ~ 0),
    
    
    future_prop_attacks3_months_100km = case_when(prop_attacks3_months_100km == 0 & prop_attacks99_months_100km > 0 ~ 1,
                                                  TRUE ~ 0),
    future_prop_attacks6_months_100km = case_when(prop_attacks6_months_100km == 0 & prop_attacks99_months_100km > 0 ~ 1,
                                                  TRUE ~ 0),
    future_prop_attacks12_months_100km = case_when(prop_attacks12_months_100km == 0 & prop_attacks99_months_100km > 0 ~ 1,
                                                   TRUE ~ 0))


save(df_attacks_prop, 
     file = here::here("processed", 
                       "df_attacks_prop.Rdata"))
